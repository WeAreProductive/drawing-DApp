...
export function useNoticeQuery(options = null) {
  return Urql.useQuery({ query: NoticeDocument, ...options });
}
...
export function useVouchersQuery(options = null) {
...
export function useVouchersByEpochAndInputQuery(options) {
...
export function useVouchersByEpochQuery(options) {
...
export function useReportQuery(options) {
  return Urql.useQuery({ query: ReportDocument, ...options });
}
