...
export interface DS4FacetInterface extends utils.Interface {
  functions: {
    "getY()": FunctionFragment;
    "setY(uint32)": FunctionFragment;
  };

  getFunction(nameOrSignatureOrTopic: "getY" | "setY"): FunctionFragment;
...
export interface DS4Facet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DS4FacetInterface;
