...
export interface IApplicationFactoryInterface extends utils.Interface {
  functions: {
...
export interface IApplicationFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IApplicationFactoryInterface;
