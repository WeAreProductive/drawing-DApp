...
export interface ERC20PortalFacetInterface extends utils.Interface {
  functions: {
...
export interface ERC20PortalFacet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20PortalFacetInterface;
