...
export interface FeeManagerFacetInterface extends utils.Interface {
  functions: {
...
export interface FeeManagerFacet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FeeManagerFacetInterface;
  ...
  functions: {
    ...
    /**
     * contract owner can reset the value of fee per claim
