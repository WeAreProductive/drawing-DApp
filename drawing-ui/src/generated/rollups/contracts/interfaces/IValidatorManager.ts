...
export interface IValidatorManagerInterface extends utils.Interface {
  functions: {
    "getCurrentClaim()": FunctionFragment;
  };

  getFunction(nameOrSignatureOrTopic: "getCurrentClaim"): FunctionFragment;
...
export interface IValidatorManager extends BaseContract {
